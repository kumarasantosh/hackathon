...
interface MarkServiceCompletedButtonProps {
  orderId: string;
  onSuccess?: () => void;
}

export function MarkServiceCompletedButton({ orderId, onSuccess }: MarkServiceCompletedButtonProps) {
  ...
  const handleMarkAsCompleted = async () => {
    ...
    try {
      const response = await fetch(`/api/orders/${orderId}/complete-service`, {
        method: "POST",
      });
